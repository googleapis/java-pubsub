...
public class PublisherImplTest {
  ...
  public void testPublishByDuration(@TestParameter boolean useTracer) throws Exception {
    ...
    Builder publisherBuilder = getTestPublisherBuilder().setBatchingSettings(
              Publisher.Builder.DEFAULT_BATCHING_SETTINGS
                      .toBuilder()
    ...
    Publisher publisher = publisherBuilder.build();
      ...
      verify(this.mockPublishRpcSpan, times(useTracer ? 4: 0)).setAttribute(PUBLISH_NUM_MESSAGES_IN_BATCH_ATTRIBUTE_KEY, 2);
   ...
   testPublisherServiceImpl.addPublishResponse(PublishResponse.newBuilder().addMessageIds("3"));
    ...
    @Test
    public void testBatchedMessagesWithOrderingKeyByNum(@TestParameter boolean useTracer) throws Exception {
      ...
      Builder publisherBuilder = getTestPublisherBuilder().setBatchingSettings(
              Publisher.Builder.DEFAULT_BATCHING_SETTINGS
                      ...
                      .setDelayThreshold(Duration.ofSeconds(100))
                      .build()).setEnableMessageOrdering(true);
      ...
      ApiFuture<String> publishFuture1 = sendTestMessageWithOrderingKey(publisher, "m1",
   "OrderA");
      ApiFuture<String> publishFuture2 = sendTestMessageWithOrderingKey(publisher, "m2",
   "OrderB");
      ApiFuture<String> publishFuture3 = sendTestMessageWithOrderingKey(publisher, "m3",
   "OrderA");
      ApiFuture<String> publishFuture4 = sendTestMessageWithOrderingKey(publisher, "m4",
   "OrderB");
      ...
      ApiFuture<String> publishFuture5 = sendTestMessageWithOrderingKey(publisher, "m5",
   "OrderA");
      ...
      ApiFuture<String> publishFuture6 = sendTestMessageWithOrderingKey(publisher, "m6",
   "OrderB");
      ...
      verify(this.mockPublishRpcSpan, times(useTracer ? 6 : 0)).setAttribute(PUBLISH_NUM_MESSAGES_IN_BATCH_ATTRIBUTE_KEY, 3);
  ...
  //    try {
  //      ApiFuture<String> publishFuture = sendTestMessageWithOrderingKey(publisher, "m1",
  // "orderA");
  ...
  //      Assert.fail("This should fail.");
  //    } catch (ExecutionException e) {
  //      assertEquals(SequentialExecutorService.CallbackExecutor.CANCELLATION_EXCEPTION,
  // e.getCause());
  //    }
  //
  //    try {
  ...
  // builder.batchingSettings.getDelayThreshold());
  //    assertEquals(
