...
public class OpenTelemetryUtil {
  ...
  public static final AttributesBuilder createPublishSpanAttributesBuilder(
    ...
    AttributesBuilder attributesBuilder = Attributes.builder()
        ...
        .put(DESTINATION_ATTR_KEY, TopicName.of(topicName, projectName).toString())
  ...
  public static final Span startPublishRpcSpan(Tracer tracer, TopicName topicName,
      List<PubsubMessageWrapper> messages, boolean enableOpenTelemetryTracing) {
    if (enableOpenTelemetryTracing && tracer != null) {
      ...
      SpanBuilder publishRpcSpanBuilder = tracer.spanBuilder(topicName.getTopic() + PUBLISH_RPC_SPAN_SUFFIX)
      ...
      return publishRpcSpanBuilder.startSpan();
    }
    return null;
  }

  public static final void endPublishRpcSpan(Span publishRpcSpan, boolean enableOpenTelemetryTracing) {
    if (enableOpenTelemetryTracing && publishRpcSpan != null) {
      publishRpcSpan.end();
    }
  }

  public static final void setPublishRpcSpanException(Span publishRpcSpan, Throwable t, boolean enableOpenTelemetryTracing) {
    if (enableOpenTelemetryTracing && publishRpcSpan != null) {
