# Google Google Cloud Pub/Sub Client for Java

Java idiomatic client for [Google Cloud Pub/Sub][product-docs].
...
You will need a [Google Cloud Platform Console][developer-console] project with the Google Cloud Pub/Sub [API enabled][enable-api].
You will need to [enable billing][enable-billing] to use Google Google Cloud Pub/Sub.
...
[Google Cloud Pub/Sub][product-docs] a fully-managed real-time messaging service that allows you to send and receive messages between independent applications.
...
[javadocs]: https://googleapis.dev/java/google-cloud-pubsub/latest/
