...
private static final long serialVersionUID = 0L;
  ...
  public interface PubsubWrapperOrBuilder extends
  ...
  private static final long serialVersionUID = 0L;
    ...
    private static final com.google.protobuf.Parser<PubsubWrapper>
        PARSER = new com.google.protobuf.AbstractParser<PubsubWrapper>() {
      @java.lang.Override
   ...
   */
  public static final class NoWrapper extends
      com.google.protobuf.GeneratedMessageV3 implements
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.google.pubsub.v1.PubsubProto.internal_static_google_pubsub_v1_PushConfig_NoWrapper_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.google.pubsub.v1.PubsubProto.internal_static_google_pubsub_v1_PushConfig_NoWrapper_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.google.pubsub.v1.PushConfig.NoWrapper.class, com.google.pubsub.v1.PushConfig.NoWrapper.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      com.google.pubsub.v1.PushConfig.NoWrapper other = (com.google.pubsub.v1.PushConfig.NoWrapper) obj;
    ...
    public static com.google.pubsub.v1.PushConfig.NoWrapper parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    ...
    public static final class Builder extends
      ...
      public com.google.pubsub.v1.PushConfig.NoWrapper buildPartial() {
        com.google.pubsub.v1.PushConfig.NoWrapper result = new com.google.pubsub.v1.PushConfig.NoWrapper(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }
    ...
    private static final com.google.protobuf.Parser<NoWrapper>
        PARSER = new com.google.protobuf.AbstractParser<NoWrapper>() {
      @java.lang.Override
  ...
  public enum WrapperCase
    ...
    public static WrapperCase forNumber(int value) {
      switch (value) {
        case 4: return PUBSUB_WRAPPER;
        case 5: return NO_WRAPPER;
   ...
   * </pre>
   *
   * <code>map&lt;string, string&gt; attributes = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  @java.lang.Override
...
java.lang.String defaultValue) {
   ...
   * </pre>
   *
   * <code>.google.pubsub.v1.PushConfig.OidcToken oidc_token = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.pubsub.v1.PushConfig.PubsubWrapper pubsub_wrapper = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.pubsub.v1.PushConfig.NoWrapper no_wrapper = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
  ...
  public int getSerializedSize() {
    ...
    if (wrapperCase_ == 4) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(4, (com.google.pubsub.v1.PushConfig.PubsubWrapper) wrapper_);
    }
    if (wrapperCase_ == 5) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(5, (com.google.pubsub.v1.PushConfig.NoWrapper) wrapper_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (wrapperCase_) {
      case 4:
        if (!getPubsubWrapper()
            .equals(other.getPubsubWrapper())) return false;
        break;
      case 5:
        if (!getNoWrapper()
            .equals(other.getNoWrapper())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.pubsub.v1.PushConfig result) {
      ...
      if (wrapperCase_ == 4 &&
          pubsubWrapperBuilder_ != null) {
        result.wrapper_ = pubsubWrapperBuilder_.build();
      }
      if (wrapperCase_ == 5 &&
          noWrapperBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  getPubsubWrapperFieldBuilder().getBuilder(),
                  extensionRegistry);
              wrapperCase_ = 4;
              break;
            } // case 34
            case 42: {
              input.readMessage(
                  getNoWrapperFieldBuilder().getBuilder(),
                  extensionRegistry);
              wrapperCase_ = 5;
              break;
            } // case 42
...
java.lang.String defaultValue) {
    ...
    public Builder setNoWrapper(
        com.google.pubsub.v1.PushConfig.NoWrapper.Builder builderForValue) {
      if (noWrapperBuilder_ == null) {
        wrapper_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeNoWrapper(com.google.pubsub.v1.PushConfig.NoWrapper value) {
      if (noWrapperBuilder_ == null) {
        if (wrapperCase_ == 5 &&
          ...
          wrapper_ = com.google.pubsub.v1.PushConfig.NoWrapper.newBuilder((com.google.pubsub.v1.PushConfig.NoWrapper) wrapper_)
              .mergeFrom(value).buildPartial();
        } else {
          wrapper_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.pubsub.v1.PushConfig.NoWrapper, com.google.pubsub.v1.PushConfig.NoWrapper.Builder, com.google.pubsub.v1.PushConfig.NoWrapperOrBuilder> 
        getNoWrapperFieldBuilder() {
      if (noWrapperBuilder_ == null) {
        if (!(wrapperCase_ == 5)) {
          wrapper_ = com.google.pubsub.v1.PushConfig.NoWrapper.getDefaultInstance();
        }
        noWrapperBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.pubsub.v1.PushConfig.NoWrapper, com.google.pubsub.v1.PushConfig.NoWrapper.Builder, com.google.pubsub.v1.PushConfig.NoWrapperOrBuilder>(
