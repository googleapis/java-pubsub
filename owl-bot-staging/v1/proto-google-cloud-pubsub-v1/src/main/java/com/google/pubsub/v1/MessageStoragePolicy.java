...
private static final long serialVersionUID = 0L;
   ...
   * </pre>
   *
   * <code>repeated string allowed_persistence_regions = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
  ...
  public int getSerializedSize() {
    ...
    if (enforceInTransit_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(2, enforceInTransit_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getEnforceInTransit()
        != other.getEnforceInTransit()) return false;
