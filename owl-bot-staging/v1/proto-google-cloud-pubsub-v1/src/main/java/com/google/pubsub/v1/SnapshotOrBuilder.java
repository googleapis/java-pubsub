...
public interface SnapshotOrBuilder extends
   ...
   * </pre>
   *
   * <code>string topic = 2 [(.google.api.field_behavior) = OPTIONAL, (.google.api.resource_reference) = { ... }</code>
   * @return The topic.
   */
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp expire_time = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
