...
public class State extends org.apache.avro.specific.SpecificRecordBase
  ...
  private static final long serialVersionUID = -5289976335034410811L;
  public static final org.apache.avro.Schema SCHEMA$ =
      new org.apache.avro.Schema.Parser()
          .parse(
              "{\"type\":\"record\",\"name\":\"State\",\"namespace\":\"pubsub\",\"doc\":\"A list of states in the United States of America.\",\"fields\":[{\"name\":\"name\",\"type\":\"string\",\"doc\":\"The common name of the state.\"},{\"name\":\"post_abbr\",\"type\":\"string\",\"doc\":\"The postal code abbreviation of the state.\"}]}");
   ...
   */
  public static pubsub.State.Builder newBuilder() {
    return new pubsub.State.Builder();
  }
   ...
   * @return A new State RecordBuilder
   */
  public static pubsub.State.Builder newBuilder(pubsub.State.Builder other) {
    if (other == null) {
      return new pubsub.State.Builder();
    } else {
      return new pubsub.State.Builder(other);
    }
  }
   ...
   * @return A new State RecordBuilder
   */
  public static pubsub.State.Builder newBuilder(pubsub.State other) {
    if (other == null) {
      return new pubsub.State.Builder();
    } else {
      return new pubsub.State.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<State>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(pubsub.State.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(pubsub.State other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
     ...
     * @return This builder.
     */
    public pubsub.State.Builder setName(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public pubsub.State.Builder clearName() {
      name = null;
     ...
     * @return This builder.
     */
    public pubsub.State.Builder setPostAbbr(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public pubsub.State.Builder clearPostAbbr() {
      post_abbr = null;
